...
### Fecha de entrega: martes 16 de septiembre, 2025

Al igual que en la práctica anterior, deben implementar los métodos faltantes de
la clase
[ListaEstudiante](https://aztlan.fciencias.unam.mx/gitlab/2026-1-icc/practica3/-/blob/main/src/main/java/mx/unam/ciencias/icc/ListaEstudiante.java).
...
[Practica3](https://aztlan.fciencias.unam.mx/gitlab/2026-1-icc/practica3/-/blob/main/src/main/java/mx/unam/ciencias/icc/Practica3.java)
al hacer:
...
```
$ git clone https://canek@aztlan.fciencias.unam.mx/gitlab/2026-1-icc/practica3.git
```
